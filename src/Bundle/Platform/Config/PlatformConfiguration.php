                        ...
                        ->arrayNode('php')
                            ...
                            ->children()
                                ...
                                ->arrayNode('extensions')
                                    ->info('Explicit extension list. Empty falls through to build-static.sh\'s own ~70-extension default list — see the build documentation.')
                                    ->scalarPrototype()->end()
                                ->end()
                                ->arrayNode('add')
                                    ->info('Extensions appended to the resolved set (the explicit list above, or build-static.sh\'s default list) — see the build documentation.')
                                    ->scalarPrototype()->end()
                                ->end()
                                ->arrayNode('remove')
                                    ->info('Extensions subtracted from the resolved set (the explicit list above, or build-static.sh\'s default list) — see the build documentation.')
                                    ->scalarPrototype()->end()
                                ->end()
